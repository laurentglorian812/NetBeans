 ...
 */
public class MenuTambahDP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TxtProvKiri = new javax.swing.JTextField();
        ...
        TxtHNoWA = new javax.swing.JTextField();
        ...
        TxtProvKiri.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        TxtProvKiri.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                TxtProvKiriKeyReleased(evt);
            }
        });
        getContentPane().add(TxtProvKiri, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 257, 600, 40));
        ...
        jLabel8.setText("Tambah Data Pelanggan");
        ...
        TxtHNoWA.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        TxtHNoWA.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                TxtHNoWAKeyReleased(evt);
            }
        });
        getContentPane().add(TxtHNoWA, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 427, 600, 40));
        ...
        TxtKodePel.setEditable(false);
        TxtKodePel.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        getContentPane().add(TxtKodePel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 87, 600, 40));
    ...
    private void TxtProvKiriKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TxtProvKiriKeyReleased
        Main.mu.validasiBatas(TxtProvKiri, 30);
    }//GEN-LAST:event_TxtProvKiriKeyReleased
    ...
    private void TxtNoHPKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TxtNoHPKeyReleased
        Main.mu.validasiBatas(TxtNoHP, 30);
    }//GEN-LAST:event_TxtNoHPKeyReleased

    private void TxtHNoWAKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TxtHNoWAKeyReleased
        Main.mu.validasiBatas(TxtHNoWA, 30);
    }//GEN-LAST:event_TxtHNoWAKeyReleased
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        setExtendedState(MenuTambahDP.MAXIMIZED_BOTH);
    ...
    private void jMenuTabelDBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuTabelDBActionPerformed
        ...
        Main.mtambahdp.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuTambahDP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuTambahDP().setVisible(true);
            }
        });
    }
    ...
    private void bersih() {
        ...
        int row = Main.mtabeldp.ModelPelanggan.getRowCount();
        TxtKodePel.setText(String.valueOf("P" + String.format("%1$" + 9 +  "s", Main.mu.nextSeq(row)).replace(' ', '0')));
    }
    
    private void simpanPelanggan() {
        try {
            String NAMA = Main.mu.kapitalisasi(TxtNama.getText());
            String ALAMAT_PEL = Main.mu.kapitalisasi(TxtAlamatPel.getText());
            String KOTA_PEL = Main.mu.kapitalisasi(TxtKotaPel.getText());
            String PROV_PEL = Main.mu.kapitalisasi(TxtProvPel.getText());
            String ALAMAT_KIRIM = Main.mu.kapitalisasi(TxtAlamatKirim.getText());
            String KOTA_KIRIM = Main.mu.kapitalisasi(TxtKotaKirim.getText());
            String PROV_KIRIM = Main.mu.kapitalisasi(TxtProvKiri.getText());
            String NO_HP = TxtNoHP.getText();
            String NO_WA = TxtHNoWA.getText();
            String NAMA_PENERIMA = Main.mu.kapitalisasi(TxtNamaPenerima.getText());

            CallableStatement cs = Main.mu.koneksi.prepareCall("{call insertPELANGGAN(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)}");
            cs.setString(1, NAMA);
            cs.setString(2, ALAMAT_PEL);
            cs.setString(3, KOTA_PEL);
            cs.setString(4, PROV_PEL);
            cs.setString(5, ALAMAT_KIRIM);
            cs.setString(6, KOTA_KIRIM);
            cs.setString(7, PROV_KIRIM);
            cs.setString(8, NO_HP);
            cs.setString(9, NO_WA);
            cs.setString(10, NAMA_PENERIMA);
            cs.executeUpdate();
            ...
            System.out.println("Kesalahan pada simpanPelanggan():");
            System.err.print(ex);
        }
    }
    ...
    private javax.swing.JTextField TxtHNoWA;
    ...
    private javax.swing.JTextField TxtProvKiri;
